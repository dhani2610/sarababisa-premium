...
class MasterKapasitasController extends Controller
{
    ...
    {
        $query = Capacity::where('cabang_id', getCabangId())->latest();
        ...
        return DataTables::of($query)
            ...
            ->addColumn('aksi', function ($row) {
                $editUrl = route('master-kapasitas.edit', $row->id);
                $deleteUrl = route('master-kapasitas.destroy', $row->id);
                $csrf = csrf_field();
    ...
    public function deleteBatch(Request $request)
    {
        ...
        // if ($hasRelation) {
        //    return response()->json(['message' => 'Data Kapasitas yang memiliki riwayat transaksi tidak bisa dihapus.'], 422);
        // }
