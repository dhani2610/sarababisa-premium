                ...
                foreach ($request->teknisi as $index => $techData) {
                    ...
                    if ($request->kondisi_servis !== 'Dibatalkan' && $userId) {
                        ...
                        if ($cekTeknisi && $cekTeknisi->bagian_teknisi == 'Teknisi Interface' && $tipeTeknisi == 'Interface') {
                            $model_id = $itemOrigin->model_series_id ?? $request->model_series_id;
                            $nama_model = ModelSerie::find($model_id);
                            ...
                            $tipe_os_id = $nama_model ? $nama_model->id_tipe_os : null;
                            $jenis_barang_id = $itemOrigin->types_id ?? $request->types_id;
