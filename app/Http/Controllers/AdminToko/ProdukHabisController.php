...
class ProdukHabisController extends Controller
{
    ...
    {
        return view('pages/admintoko/produk/habis');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin-item-habis.index');
    }
    ...
    public function import(Request $request)
    {
        ...
        return redirect()->route('admin-item-habis.index')->with('success', 'All good!');
    }
