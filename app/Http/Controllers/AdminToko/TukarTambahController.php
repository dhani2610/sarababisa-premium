...
class TukarTambahController extends Controller
{
    ...
    {
        return view('pages/admintoko/pembelian/tukar-tambah');
    }
    ...
    public function create()
    {
        ...
        $colors = Color::all();
        return view('pages/admintoko/pembelian/input-tukar-tambah', compact('customers', 'products', 'sales', 'brands', 'model_series', 'capacities', 'colors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        OrderDetail::create([
            ...
            'profit_toko' => ($request->price - $produk_jual->harga_modal) - ($request->price - $produk_jual->harga_modal) / 100 * ($persen_sales->persen + $persen_admin),
            'payment_method' => $request->payment_method,
            'is_admin_toko'      => 'Admin',
