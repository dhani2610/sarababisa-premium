...
class ProdukTersediaController extends Controller
{
    ...
    {
        return view('pages/admintoko/produk/tersedia');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin-item-tersedia.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.admintoko.produk.tersedia-edit', [
            'item' => $item,
    ...
    public function import(Request $request)
    {
        ...
        return redirect()->route('admin-item-tersedia.index')->with('success', 'All good!');
    }
