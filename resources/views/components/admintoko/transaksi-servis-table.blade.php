<div class="bg-white shadow-lg rounded-sm border border-slate-200 mb-8">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-slate-800">Proses <span class="text-slate-400 font-medium">{{ $count }}</span></h2>
    </header>
    <!-- Table -->
        ...
        <table class="table-auto w-full">
            ...
            <thead class="text-xs font-semibold uppercase text-slate-500 bg-slate-50 border-t border-b border-slate-200">
                <tr>
                    ...
                    {{-- <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                        <div class="font-semibold text-left">Lama</div>
                    </th> --}}
                    <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
            ...
            <tbody class="text-sm divide-y divide-slate-200">
                ...
                @foreach($processes as $process)
                    ...
                    <tr>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <a href="{{ route('admin-transaksi-servis.edit', $process->id) }}">
                        ...
                        {{-- <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-medium">5 Hari</div>
                        </td> --}}
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                            <div class="space-x-1 flex">
                                <a href="{{ route('admin-servis-bisa-diambil.show', $process->id) }}">
                                            ...
                                            <div class="bg-white rounded shadow-lg overflow-auto max-w-xl w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                                ...
                                                <div class="px-5 py-4">
                                                    <div class="flex flex-wrap justify-end space-x-2">
                                                        ...
                                                        <a href="{{ route('cetak-termal', $process->id) }}"  hidetargetblank>
                                                        ...
                                                        <a href="{{ route('cetak-tanda-terima', $process->id) }}"  hidetargetblank>
                                        ...
                                        <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                            <div class="p-5 flex space-x-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="flex flex-wrap justify-end space-x-2">
                                                        <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600" @click="modalOpen = false">Batal</button>
                                                        <form action="{{ route('admin-transaksi-servis.destroy', $process->id) }}" method="post">
                                                            @method('delete')
                                                            @csrf
