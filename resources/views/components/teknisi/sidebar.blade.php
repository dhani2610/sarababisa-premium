        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <!-- Transaksi Servis -->
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(1), ['teknisi-transaksi-servis', 'teknisi-servis-bisa-diambil', 'teknisi-servis-sudah-diambil'])){{ 'bg-slate-900' }}@endif">
