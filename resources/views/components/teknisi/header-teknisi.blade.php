            ...
            <div class="flex items-center mb-4 md:mb-0">
                ...
                <div>
                    @if ($toko->is_bonus === 1)
                        ...
                        <div class="text-3xl font-bold text-emerald-500">Rp. {{ number_format($totalbonus) }} (Total) | Rp. {{ number_format($totalbonusHardware) }} (HardWare) | Rp. {{ number_format($totalbonusInterface) }} (Interface)</div>
                        @if ($target != 0)
                            @if ($result < $target)
