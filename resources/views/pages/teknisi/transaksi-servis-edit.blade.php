                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('teknisi-transaksi-servis.index') }}" class="text-slate-400 hover:text-slate-500">
                    ...
                    <!-- Modal content -->
                    <form action="{{ route('teknisi-transaksi-servis.update', $item->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <input id="kelengkapan" name="kelengkapan" class="form-input w-full px-2 py-1" type="text" placeholder="Kosongkan jika kelengkapannya hanya unit" value="{{ $item->kelengkapan }}"/>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="users_id" name="users_id" class="form-input w-full px-2 py-1 disabled:border-slate-200 disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed" value="{{ $item->user->name }}" disabled>
                                </div>
                            </div>
                        </div>
                        <!-- Modal footer -->
