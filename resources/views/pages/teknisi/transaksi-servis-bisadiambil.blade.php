        ...
        <div x-data="{ modalOpen: true }">
            ...
            <div id="tambah-modal"
                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            <div class="font-semibold text-sm text-slate-800">Ubah status untuk nomor servis
                                #{{ $item->nomor_servis }} menjadi <strong>Bisa Diambil</strong></div>
                    ...
                    <!-- Modal content -->
                    <form action="{{ route('teknisi-ubah-bisa-diambil-update', $item->id) }}" method="post">
                        @csrf
                        ...
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <input
                                        class="form-input w-full px-2 py-1 disabled:border-slate-200 disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed"
                                        type="text" value="{{ $item->warna }} - {{ $item->capacity->name }}"
                                        disabled />
                                </div>
                                <div>
                                ...
                                <div x-data="{ showDetails: true }">
                                    <label class="block text-sm font-medium mb-1" for="kondisi_servis">Kondisi Servis
                                        ...
                                        <div class="m-3">
                                            ...
                                            <label class="flex items-center">
                                                <input type="radio" name="kondisi_servis"
                                                    value="Menunggu konfirmasi" class="form-radio"
                                    ...
                                    <div x-show="showDetails" class="mt-3 space-y-3">
                                        ...
                                        {{-- Konfirmasi stok sparepart toko --}}
                                        <div x-data="{ showDetails: false }" class="konfirmasi-stok border-b-2 pb-4">
