    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="flex flex-col col-span-full sm:col-span-6">
                <livewire:pos.sales-index :cartInstance="'sale'" />
            </div>
        </div>
        <!-- Start -->
                        ...
                        <div class="relative">
                            ...
                            <div class="text-center">
                                ...
                                <div class="flex justify-center space-x-2">
                                    <a href="{{ route('sales-cetak-termal-produk', $order->id) }}"  hidetargetblank>
                                    ...
                                    <a href="{{ route('sales-lunas-cetak-inkjet', $order->id) }}"  hidetargetblank>
