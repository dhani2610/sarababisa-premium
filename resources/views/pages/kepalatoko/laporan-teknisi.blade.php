    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-3">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Laporan Teknisi ✨</h1>
            </div>

            <!-- Right: Actions -->
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">

                <a href="{{ route('target-teknisi.index') }}" class="btn bg-white border-blue-200 hover:border-blue-300 text-blue-600">
                    Target Teknisi
                </a>
                ...
                <div class="relative inline-flex" x-data="{ modalOpen: false }">
                    ...
                    >
                        <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                            ...
                            <!-- Modal content -->
                            <form action="{{ route('cetak-laporan-teknisi') }}" method="get"  hidetargetblank>
                                @csrf
                                <div class="px-5 py-4">
                                    <div class="space-y-3">
                                        <div>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="users_id">Akun Teknisi <span class="text-rose-500">*</span></label>
