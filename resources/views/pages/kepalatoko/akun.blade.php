...
<x-toko-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                                ...
                                <div class="px-5 py-4">
                                    <div class="space-y-3">
                                        ...
                                        <div id="persen_investor_input" style="display: none">
                                            <label class="block text-sm font-medium mb-1"
                                                for="persen_investor">Persentase Pembagian Servis<span
                                                    class="text-rose-500">*</span></label>
                                            <input id="persen_investor" name="persen_investor"
                                                class="form-input w-full px-2 py-1" type="number" />
                                        </div>
                                        <div id="persen_investor_input_produk" style="display: none">
                                            <label class="block text-sm font-medium mb-1"
                                                for="persen_investor_produk">Persentase Pembagian Produk<span
                                                    class="text-rose-500">*</span></label>
                                            <input id="persen_investor_produk" name="persen_investor_produk"
                                                class="form-input w-full px-2 py-1" type="number" />
                                        </div>

                                        <div id="kategori_investor_input" style="display: none;" class="mt-3">
                                            <label class="block text-sm font-medium mb-1" for="kategori_investor">
                                                Kategori Investor <span class="text-xs text-slate-400">(Bisa pilih
                                                    lebih dari satu)</span>
                                            </label>
                                            <select id="kategori_investor" name="kategori_investor[]"
                                                class="form-select text-sm py-1 w-full select2-multiple"
                                                multiple="multiple">
                                        ...
                                        <div id="shift_input" style="display: none">
                                            ...
                                            <select id="shift_id" name="shift_id"
                                                ...
                                                @foreach ($shift as $item)
                                                    <option value="{{ $item->id }}">{{ $item->nama_shift }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div id="upload-investor" style="display: none;">
                                            ...
                                            <input id="pdf_investor" name="pdf_investor"
                                                class="form-input w-full px-2 py-1" type="file"
                                        ...
                                        <div id="extra-fields">
                                            ...
                                            <br>
                                            <div id="bonus-leveling-container"
                                                class="mt-3 border border-slate-200 rounded p-3 bg-slate-50"
                                                style="display: none;">
                                                <small for="">
                                                    <a href="{{ asset('import/Format_Leveling.xlsx') }}"
                                                        download="" style="color:blue">Download Format</a>
                                                </small>
                                                <div class="flex justify-between items-center mb-2">
                                                    <label class="block text-sm font-bold text-slate-800">Setting Bonus
                                                        Leveling Interface</label>

                                                    <div class="flex space-x-2">
                                                        <input type="file" id="excel_file" accept=".xlsx, .xls"
                                                            style="display: none;" onchange="processExcel(this)">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            onclick="addLevelingRow()">+ Tambah</button>
                                                    </div>
                                                </div>

                                                <div id="leveling-rows-wrapper" class="space-y-2">
                                                    <div
                                                        class="leveling-row grid grid-cols-1 md:grid-cols-12 gap-2 items-end border-b pb-2">
                                                        <div class="md:col-span-3">
                                                            <label class="block text-xs font-medium mb-1">Jenis
                                                                Barang</label>
                                                            <select name="lvl_id_jenis_barang[]"
                                                                class="form-select text-xs w-full py-1">
                                                        ...
                                                        <div class="md:col-span-2">
                                                            <label class="block text-xs font-medium mb-1">Tipe
                                                                OS</label>
                                                            <select name="lvl_id_tipe_os[]"
                                                                class="form-select text-xs w-full py-1">
                                                        ...
                                                        <div class="md:col-span-2">
                                                            <label class="block text-xs font-medium mb-1">Dari
                                                                Rate</label>
                                                            <input type="text" name="lvl_start_rate[]"
                                                                class="form-input text-xs w-full py-1 input-currency"
                                                                placeholder="Rp 0">
                                                        </div>
                                                        <div class="md:col-span-2">
                                                            <label class="block text-xs font-medium mb-1">Sampai
                                                                Rate</label>
                                                            <input type="text" name="lvl_end_rate[]"
                                                                class="form-input text-xs w-full py-1 input-currency"
                                                                placeholder="Rp 0">
                                                        </div>
                                                        <div class="md:col-span-2">
                                                            <label class="block text-xs font-medium mb-1">Bonus</label>
                                                            <input type="text" name="lvl_nominal_bonus[]"
                                                                class="form-input text-xs w-full py-1 input-currency"
                                                                placeholder="Rp Bonus">
                                                        </div>
                                                        <div class="md:col-span-1 text-center">
                                                            <button type="button"
                                                                class="text-rose-500 hover:text-rose-700"
                                                                onclick="removeLevelingRow(this)">
                                                                <svg class="w-4 h-4 fill-current" viewBox="0 0 16 16">
                                                                    <path
                                                                        d="M5 7h2v6H5V7zm4 0h2v6H9V7zm3-6v2h4v2h-1v10c0 .6-.4 1-1 1H2c-.6 0-1-.4-1-1V5H0V3h4V1c0-.6.4-1 1-1h6c.6 0 1 .4 1 1z" />
                                                                </svg>
                                                            </button>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="mt-6 border-t border-slate-200 pt-4">
                                        <span class="font-semibold text-slate-800 mb-4">Detail Akun (Dokumen)</h3>
                                            <p style="color: red" class="text-xs text-slate-500 mt-1">Format: JPG,
                                                PNG, atau PDF</p>
                                            <hr>
                                            <div class="space-y-3">
                                                <div>
                                                    ...
                                                    <input id="foto_ktp" name="foto_ktp"
                                                        class="form-input w-full px-2 py-1 text-sm" type="file"
                                                ...
                                                <div>
                                                    ...
                                                    <input id="foto_ijasah" name="foto_ijasah"
                                                        class="form-input w-full px-2 py-1 text-sm" type="file"
                                                        accept=".pdf,.jpg,.jpeg,.png" />
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <input id="dokumen_lain" name="dokumen_lain"
                                                        class="form-input w-full px-2 py-1 text-sm" type="file"
                                                        accept=".pdf,.jpg,.jpeg,.png" />
                                                </div>
                                            </div>
        ...
        <div x-data="{ detailModalOpen: false }" @open-detail-modal.window="detailModalOpen = true">
            <div class="fixed inset-0 bg-slate-900 bg-opacity-30 z-50 transition-opacity" x-show="detailModalOpen"
                x-cloak></div>
            <div class="fixed inset-0 z-50 overflow-hidden flex items-center justify-center px-4 sm:px-6"
                role="dialog" aria-modal="true" x-show="detailModalOpen" x-cloak>
        ...
        <div class="bg-white shadow-lg rounded-sm border border-slate-200 mt-5 mb-8">
            <div class="sm:flex sm:justify-between sm:items-center px-5 py-4">
                {{-- Left side --}}
                <h2 class="font-semibold text-slate-800">Semua Akun <span
        ...
        function toggleInputs() {
            ...
            if (role === 'Investor') {
                ...
                if (bagianTeknisi === 'Teknisi Interface') {
                    ...
                    if(bonusLevelingContainer) bonusLevelingContainer.style.display = 'none';
                    if(bonusPersen) bonusPersen.style.display = 'block'; // Sembunyikan Hardware
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.length > 0) {
                        ...
                        rows =
                            '<tr><td colspan="4" class="text-center py-4 text-slate-400">Tidak ada data leveling.</td></tr>';
                    }
                    $('#detail-bonus-body').html(rows);
                },
                error: function() {
                    $('#detail-bonus-body').html(
                        '<tr><td colspan="4" class="text-center py-4 text-rose-500">Gagal memuat data.</td></tr>'
                        );
                }
            });
        });
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.select2-multiple').select2({
                    ...
                    allowClear: true,
                    width: '100%',
                    // SANGAT PENTING: Supaya dropdown tidak ngumpet di belakang Modal Alpine.js
            ...
            $(document).ready(function() {
                var table = $('#akun-table').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'persen_investor',
                            name: 'persen_investor'
                        },
                        {
                            data: 'persen_investor_produk',
                            name: 'persen_investor_produk'
                        },
                        {
                            data: 'shift_name',
                    ...
                    order: [
                        [1, 'asc']
                    ], // Default urut berdasarkan Nama (index ke-3)
                    language: {
