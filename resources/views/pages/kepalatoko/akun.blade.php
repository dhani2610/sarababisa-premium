...
<x-toko-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                                ...
                                <div class="px-5 py-4">
                                    <div class="space-y-3">
                                        ...
                                        <div>
                                            ...
                                            <input id="nik" name="nik" class="form-input w-full px-2 py-1" type="number" required />
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="nomor_hp">HP <span class="text-rose-500">*</span></label>
                                            <input id="nomor_hp" name="nomor_hp" class="form-input w-full px-2 py-1" type="number" required />
                                        </div>
                                        <div>
        ...
        <!-- Table -->
        <x-kepalatoko.akun-table :users="$users" :count="$users_count" />
