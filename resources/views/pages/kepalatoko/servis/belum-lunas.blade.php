@section('title')
    Transaksi Servis Belum Lunas
@endsection

<x-toko-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <livewire:belum-lunas-data></livewire:belum-lunas-data>
    </div>

    @push('styles')
        <style>
            div.dataTables_wrapper div.dataTables_length select { width: 47%!important; display: inline-block; }
            .dataTables_wrapper .dataTables_length { float: left; padding-left: 2%; }
        </style>
        ...
        <script>
            $(document).ready(function() {
                ...
                function loadBatch() {
                    ...
                    $.ajax({
                        url: '{{ route('transaksi-servis-belum-lunas.data') }}',
                        type: 'GET',
                        data: {
                            offset: offset,
                            limit: batchSize
