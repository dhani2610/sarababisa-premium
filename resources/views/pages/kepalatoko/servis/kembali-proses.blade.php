                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-xl w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            <div class="font-semibold text-sm text-slate-800">Ubah status untuk nomor servis #{{ $item->nomor_servis }} kembali ke <strong>Proses</strong></div>
                    ...
                    <!-- Modal content -->
                    <form action="{{ route('kembali-proses', $item->id) }}" method="post">
                        @csrf
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                <div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="status_servis">Status Servis  </label>
                                    <select id="status_servis" name="status_servis" class="form-select text-sm py-1 w-full" >
