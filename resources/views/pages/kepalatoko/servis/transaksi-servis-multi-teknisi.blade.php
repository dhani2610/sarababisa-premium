                            ...
                            <div class="space-y-3" x-data="{ showDetails: true }">
                                ...
                                <div class="bg-slate-100 p-3 rounded">
                                    <div class="mb-2">
                                        ...
                                        <input class="form-input w-full px-2 py-1 bg-white" type="text" name="total_modal_sparepart" id="total_modal_sparepart" required value="0" />
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium mb-1" for="biaya">Total Biaya Servis (Ke Pelanggan) <span class="text-rose-500">*</span></label>
                                        <input class="form-input w-full px-2 py-1 bg-white font-bold text-lg" type="text" name="biaya" id="biaya" required  value="0"/>
                                    </div>
                                </div>
