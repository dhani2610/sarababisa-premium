    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-5">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Anggaran ✨</h1>
            </div>
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <!-- Search form -->
                <x-search-form placeholder="Cari berdasarkan nama anggaran" />
                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            <div class="font-semibold text-slate-800">Edit Anggaran</div>
                            <a href="{{ route('anggaran.index') }}" class="text-slate-400 hover:text-slate-500">
