                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            <div class="font-semibold text-slate-800">Edit Tool</div>
                            <a href="{{ route('tool.index') }}" class="text-slate-400 hover:text-slate-500">
                    ...
                    <!-- Modal content -->
                    <form action="{{ route('tool.update', $item->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="sub_categories_id">Sub Kategori <span class="text-rose-500">*</span></label>
                                    <select id="sub_categories_id" name="sub_categories_id" class="form-select text-sm py-1 w-full" style="width: 100%">
                        ...
                        <div class="px-5 py-4 border-t border-slate-200">
                            <div class="flex flex-wrap justify-end space-x-2">
                                <a href="{{ route('tool.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                    Batal
                                </a>
