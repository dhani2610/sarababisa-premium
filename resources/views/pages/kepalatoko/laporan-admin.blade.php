                            ...
                            <form action="{{ route('cetak-laporan-admin') }}" method="get"  hidetargetblank>
                                ...
                                <div class="px-5 py-4">
                                    <div class="space-y-3">
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="admin_id">Akun Admin <span class="text-rose-500">*</span></label>
                                            <select id="admin_id" name="admin_id" class="form-select text-sm py-1 w-full" required>
