@section('title')
    Laporan Pajak Transaksi Produk
@endsection
            ...
            <div
                ...
                <div class="px-5 p-5">
                    <header class="flex justify-between items-start mb-2">
                        ...
                        <!-- Menu button -->
                        <div class="text-sm font-semibold text-white px-1.5 bg-indigo-500 rounded-full">
                            {{ \Carbon\Carbon::parse(strtotime(now()))->translatedFormat('d F Y') }}</div>
                    </header>
            ...
            <div
                ...
                <div class="px-5 p-5">
                    <header class="flex justify-between items-start mb-2">
                        ...
                        <!-- Menu button -->
                        <div class="text-sm font-semibold text-white px-1.5 bg-indigo-500 rounded-full">
                            {{ \Carbon\Carbon::parse(strtotime(now()))->translatedFormat('F') }}</div>
                    </header>
                    <div class="flex justify-between">
                        <div>
                            <div class="text-xs font-semibold text-slate-400 uppercase mb-1">Omzet</div>
            ...
            <div
                ...
                <div class="p-5">
                    <header class="flex justify-between items-start mb-2">
                        ...
                        <!-- Menu button -->
                        <div class="text-sm font-semibold text-white px-1.5 bg-indigo-500 rounded-full">
                            {{ \Carbon\Carbon::parse(strtotime(now()))->format('Y') }}</div>
                    </header>
                    <div class="flex justify-between">
                        <div>
                            <div class="text-xs font-semibold text-slate-400 uppercase mb-1">Omzet</div>
                        ...
                        <div>
                            <div class="text-xs font-semibold text-slate-400 uppercase mb-1">Pajak</div>
                            <div class="text-xl font-bold text-emerald-500">Rp. {{ number_format($profittahun) }}</div>
                        </div>
                    </div>
                </div>
            </div>
