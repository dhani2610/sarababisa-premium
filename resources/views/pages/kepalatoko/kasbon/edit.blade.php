    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-5">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <!-- Search form -->
                <x-search-form placeholder="Cari berdasarkan item kasbon" />
                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('kasbon.index') }}" class="text-slate-400 hover:text-slate-500">
                        ...
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input id="total" name="total" class="form-input w-full pl-10 px-2 py-1 input-currency" type="text" value="{{ $item->total }}"/>
