    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-5">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <!-- Search form -->
                <x-search-form placeholder="Cari berdasarkan item inventaris" />
                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            <div class="font-semibold text-slate-800">Edit Inventaris</div>
                            <a href="{{ route('inventaris.index') }}" class="text-slate-400 hover:text-slate-500">
                    ...
                    <form action="{{ route('inventaris.update', $item->id) }}" method="post">
                        ...
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="created_at">Tanggal Pembelian</label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="name">Nama Barang</label>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input id="price" name="price" class="form-input w-full pl-10 px-2 py-1 input-currency" type="text" value="{{ $item->price }}"/>
                                ...
                                <div>
                                    ...
                                    <input id="masa_penggantian" name="masa_penggantian" class="form-input w-full px-2 py-1" type="date" value="{{ \Carbon\Carbon::parse($item->masa_penggantian)->format('Y-m-d') }}"/>
                                </div>
                            </div>
                        </div>
                        <!-- Modal footer -->
                        <div class="px-5 py-4 border-t border-slate-200">
                            <div class="flex flex-wrap justify-end space-x-2">
                                <a href="{{ route('inventaris.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                    Batal
                                </a>
