    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-5">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <!-- Search form -->
                <x-search-form placeholder="Cari berdasarkan nama insiden" />
                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            <div class="font-semibold text-slate-800">Edit Insiden</div>
                            <a href="{{ route('insiden.index') }}" class="text-slate-400 hover:text-slate-500">
                    ...
                    <!-- Modal content -->
                    <form action="{{ route('insiden.update', $item->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="created_at">Tgl. Insiden </label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="name">Nama Insiden</label>
                                    <input id="name" name="name" class="form-input w-full px-2 py-1" type="text" value="{{ $item->name }}" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="price">Biaya Insiden</label>
                                    <input id="price" name="price" class="input-currency form-input w-full px-2 py-1" type="text" value="{{ $item->price }}" />
                                </div>
                                <div>
                        ...
                        <div class="px-5 py-4 border-t border-slate-200">
                            <div class="flex flex-wrap justify-end space-x-2">
                                <a href="{{ route('insiden.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                    Batal
                                </a>
