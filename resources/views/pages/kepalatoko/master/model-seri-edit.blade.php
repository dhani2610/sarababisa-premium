                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            <div class="font-semibold text-slate-800">Edit Jenis Barang</div>
                            <a href="{{ route('master-model-seri.index') }}" class="text-slate-400 hover:text-slate-500">
                    ...
                    <form action="{{ route('master-model-seri.update', $item->id) }}" method="post">
                        ...
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                ...
                                @endif
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="name">Nama Model Seri</label>
                        ...
                        <div class="px-5 py-4 border-t border-slate-200">
                            <div class="flex flex-wrap justify-end space-x-2">
                                <a href="{{ route('master-model-seri.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                    Batal
                                </a>
