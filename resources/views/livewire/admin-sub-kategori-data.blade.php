                        ...
                        <form action="{{ route('admin-sub-kategori.store') }}" method="post">
                            ...
                            <div class="px-5 py-4 border-t border-slate-200">
                                <div class="flex flex-wrap justify-end space-x-2">
                                    <a href="{{ route('admin-sub-kategori.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                        Batal
                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="space-x-1 flex">
                                        <a href="{{ route('admin-sub-kategori.edit', $item->id) }}">
                                                    ...
                                                    <div class="p-5 flex space-x-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="flex flex-wrap justify-end space-x-2">
                                                                ...
                                                                <form action="{{ route('admin-sub-kategori.destroy', $item->id) }}" method="post">
                                                                    @method('delete')
                                                                    @csrf
