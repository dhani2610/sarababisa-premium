    ...
    <style>
                ...
                <ul class="flex flex-wrap -m-1">
                    ...
                    <li class="m-1">
                        <a href="{{ route('keranjang-kasbon') }}">
                            <button class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm bg-indigo-500 text-white duration-150 ease-in-out">Kasbon</button>
                        </a>
                    </li>
                    <li class="m-1">
        ...
        <div class="bg-white shadow-lg rounded-sm border border-slate-200 mt-5 mb-8">
            ...
            <div class="p-5 overflow-x-auto">
                <table id="trashDebtTable" class="table-auto w-full">
                    <thead class="text-xs font-semibold uppercase text-slate-500 bg-slate-50 border-t border-b border-slate-200">
                        <tr>
                            ...
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap text-left">Tanggal Kasbon</th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap text-left">Nama Karyawan</th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap text-left">Nominal</th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap text-left">Keterangan</th>
...
<script>
    $(document).ready(function () {
        $('#trashDebtTable').DataTable({
            serverSide: false, // Search client-side
            processing: true,
            ajax: "{{ route('keranjang-kasbon') }}",
            columns: [
            ...
            language: {
                ...
                emptyTable: "Tidak ada data sampah kasbon"
            }
        });
    });
</script>
