<div x-data>
    ...
    <div class="text-sm mb-3 text-slate-600">
        Atur nominal overtime per jam  karyawan.
    </div>

    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <!-- Potongan Izin -->
        <div>
            <label class="block text-sm font-medium text-slate-700 mb-1">Nominal Overtime</label>
            <input
                type="text"
                wire:model.defer="nominal_overtime"
