                    ...
                    <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                        ...
                        <div x-data="{ tab: '1' }" class="px-5 py-4">
                            ...
                            <div class="flex flex-wrap items-center -m-3 mb-0">
                                ...
                                @foreach ($productCategoty as $pc)
                                    <div class="m-3">
                                        <!-- Start -->
                                        <label class="flex items-center">
                                            <input type="radio" name="radio-buttons" class="form-radio" checked @click="tab = '$pc->id'"/>
                                            <span class="text-sm ml-2">{{ $pc->category_name }}</span>
                                        </label>
                                        <!-- End -->
                                    </div>
                                @endforeach
                            ...
                            @foreach ($productCategoty as $pc)
                            <div x-show="tab === '{{ $pc->id }}'">
                                <form action="{{ route('handphone.store') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="categories_id" value="{{ $pc->id }}">
                                    <div class="space-y-3">
                                        <div>
            ...
            <div class="relative inline-flex" x-data="{ modalOpen: false }">
                ...
                >
                    <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                        ...
                        <!-- Modal content -->
                        <form action="{{ route('cetak-laporan-produk') }}" method="get"  hidetargetblank>
                            @csrf
                            <div class="px-5 py-4">
                                <div class="space-y-3">
                                    <div>
                                                    ...
                                                    <div class="p-5 flex space-x-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="flex flex-wrap justify-end space-x-2">
                                                                ...
                                                                <form x-bind:action="'{{ route('item.destroy', '') }}/' + deleteId" method="post">
                                                                    @method('delete')
                                                                    @csrf
