    ...
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 mt-5 mb-8">
        <div x-data="handleSelect">
            <div class="sm:flex sm:justify-between sm:items-center px-5 py-4">
                {{-- Left side --}}
                <h2 class="font-semibold text-slate-800">Lunas <span class="text-slate-400 font-medium">{{ $jumlah_lunas }}</span></h2>
                {{-- Right side --}}
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('handleSelect', () => ({
                ...
                deleteSelected() {
                    ...
                    fetch('/paid-product-transactions/delete', {
                        method: 'DELETE',
                        headers: {
                ...
                approveSelected() {
                    ...
                    fetch('/paid-product-transactions/update', {
                        method: 'PATCH',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                ...
                rejectSelected() {
                    ...
                    // Kirim permintaan update ke server
                    fetch('/paid-product-transactions/reject', {
                        method: 'PATCH',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
