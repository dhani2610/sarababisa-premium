    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="mb-4 sm:mb-0">
            <ul class="flex flex-wrap -m-1">
                <li class="m-1">
                    <a href="{{ route('sales-transaksi-produk.index') }}">
                        <button class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm  bg-indigo-500 text-white duration-150 ease-in-out">Semua <span class="ml-1 text-indigo-200">{{ $jumlah_semua }}</span></button>
                    </a>
                </li>
                <li class="m-1">
                    <a href="{{ route('sales-transaksi-produk-paid.index') }}">
                ...
                <li class="m-1">
                    <a href="{{ route('sales-transaksi-produk-due.index') }}">
                        <button class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-slate-200 hover:border-slate-300 shadow-sm bg-white text-slate-500 duration-150 ease-in-out">Belum Lunas <span class="ml-1 text-slate-400">{{ $jumlah_tidaklunas }}</span></button>
                    </a>
                </li>
            </ul>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="space-x-1 flex">
                                    <!-- Detail -->
                                    <a href="{{ route('sales-transaksi-produk.show', $item->id) }}">
