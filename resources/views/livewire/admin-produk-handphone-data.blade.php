<div>
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <!-- Start Export Excel -->
            <a href="{{ route('admin-ekspor-handphone') }}" class="hidden lg:block">
                ...
                <button class="btn bg-white border-emerald-200 hover:border-emerald-300 text-emerald-700" @click.prevent="modalOpen = true" aria-controls="tambah-modal">
                    ...
                    >
                        <div class="bg-white rounded shadow-lg overflow-auto max-w-xl w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                            <form action="{{ route('admin-impor-handphone') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                <!-- Modal header -->
                                <div class="px-5 py-3 border-b border-slate-200">
                                    <div class="flex justify-between items-center">
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="space-x-1 flex">
                                        ...
                                        <a href="{{ route('download-barcode', $item->id) }}">
                                            <button class="text-slate-400 mt-2 hover:text-slate-500 rounded-full">
                                                        ...
                                                        <div class="p-5 flex space-x-4">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="flex flex-wrap justify-end space-x-2">
                                                                    ...
                                                                    <form x-bind:action="'{{ route('admin-handphone.destroy', '') }}/' + deleteId" method="post">
                                                                        @method('delete')
                                                                        @csrf
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('handleSelect', () => ({
                ...
                updatePortalStatus(action) {
                    ...
                    fetch('/admin-products/update-portal', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
