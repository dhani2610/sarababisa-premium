                        ...
                        <form action="{{ route('handphone.store') }}" method="post">
                            ...
                            <div class="px-5 py-4 border-t border-slate-200">
                                <div class="flex flex-wrap justify-end space-x-2">
                                    <a href="{{ route('handphone.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                        Batal
                                    </a>
            ...
            <div class="relative inline-flex" x-data="{ modalOpen: false }">
                ...
                >
                    <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                        ...
                        <!-- Modal content -->
                        <form action="{{ route('cetak-laporan-produk-handphone') }}" method="get"  target="_blank">
                            @csrf
                            <div class="px-5 py-4">
                                <div class="space-y-3">
                                    <div>
                ...
                <button class="btn bg-white border-emerald-200 hover:border-emerald-300 text-emerald-700" @click.prevent="modalOpen = true" aria-controls="tambah-modal">
                    ...
                    >
                        <div class="bg-white rounded shadow-lg overflow-auto max-w-xl w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                            {{-- <form action="{{ route('impor-handphone') }}" method="post" enctype="multipart/form-data"> --}}
                                <!-- Modal header -->
                                <div class="px-5 py-3 border-b border-slate-200">
                                    <div class="flex justify-between items-center">
                                ...
                                <div class="px-5 pt-4 pb-1">
                                    <div class="text-sm">
                                        <div class="space-y-2">
                                            ...
                                            <input type="file" id="file_import" name="file"  class="btn-sm bg-slate-100 w-full" required>
                                ...
                                <div class="px-5 py-4">
                                    <div class="flex flex-wrap justify-end space-x-2">
                                        <a href="{{ asset('storage/assets/format_handphone.xlsx') }}" class="btn-sm bg-orange-500 hover:bg-orange-600 text-white">
                                            <span class="mr-1">
                ...
                <table id="produk-table" class="table-auto w-full">
                    ...
                    <thead class="text-xs font-semibold uppercase text-slate-500 bg-slate-50 border-t border-b border-slate-200">
                        <tr>
                            ...
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">Tgl In</div>
                            </th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">Tgl Out</div>
                            </th>
                ...
                for (let i = 0; i < totalChunks; i++) {
                    ...
                    try {
                        const response = await $.ajax({
                            url: "{{ route('produk.handphone.import-chunk') }}",
                            method: "POST",
                            data: {
                                _token: "{{ csrf_token() }}",
                                rows: chunk
