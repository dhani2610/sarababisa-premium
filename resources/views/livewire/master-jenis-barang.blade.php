<div>
    <div class="sm:flex sm:justify-between sm:items-center mb-3">
        ...
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Jenis Barang ✨</h1>
        </div>
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <div x-data="{ modalOpen: false }">
                <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" @click.prevent="modalOpen = true">
                    ...
                    <span class="hidden xs:block ml-2">Tambah Jenis Barang</span>
                </button>
    ...
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 mt-5 mb-8">
        ...
        <div class="sm:flex sm:justify-between sm:items-center px-5 py-4">
            <h2 class="font-semibold text-slate-800">Semua Jenis Barang <span class="text-slate-400 font-medium">{{ $types_count }}</span></h2>
        ...
        <div class="overflow-x-auto p-4">
            <table id="jenis-barang-table" class="table-auto w-full">
                <thead class="text-xs font-semibold uppercase text-slate-500 bg-slate-50 border-t border-b border-slate-200">
                    <tr>
                        ...
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">Nama Jenis Barang</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            function attachCheckboxHandlers() {
                ...
                $('#jenis-barang-table').off('change', '.table-item').on('change', '.table-item', function() {
            ...
            window.deleteSelected = function() {
                ...
                $.ajax({
                    url: "{{route('master-jenis-barang.deleteSelected')}}",
                    method: 'DELETE',
                    data: {
