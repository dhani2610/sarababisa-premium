<div>
    ...
    <button
        class="btn bg-white border-slate-200 hover:border-slate-300 text-slate-500 hover:text-slate-600 mr-2"
        @click.prevent="modalOpen = true"
        aria-controls="print-modal"
    >
        <span class="sr-only">Print</span>
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-printer" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6366f1" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
            ...
            <div class="px-5 py-3 border-b border-slate-200">
                <div class="flex justify-between items-center">
                    <div class="font-semibold text-slate-800">Cetak Laporan Pembelian</div>
            ...
            <form action="{{ route('purchase.cetak') }}" method="get" target="_blank">
                @csrf
                <div class="px-5 py-4">
                    <div class="space-y-3">
                        <div>
                ...
                <div class="px-5 py-4 border-t border-slate-200">
                    <div class="flex flex-wrap justify-end space-x-2">
                        ...
                        <button type="submit" class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white" @click="modalOpen = false">Cetak PDF</button>
                    </div>
                </div>
            </form>
        </div>
