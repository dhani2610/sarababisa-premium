            ...
            <div class="relative inline-flex" x-data="{ modalOpen: false }">
                ...
                >
                    <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                        ...
                        <!-- Modal content -->
                        <form action="{{ route('cetak-laporan-bisa-diambil') }}" method="get"  hidetargetblank>
                            @csrf
                            <div class="px-5 py-4">
                                <div class="space-y-3">
                                    <div>
                            ...
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium">
                                        {{-- Decode JSON, gabungkan dengan koma, dan berikan fallback array kosong jika data null --}}
