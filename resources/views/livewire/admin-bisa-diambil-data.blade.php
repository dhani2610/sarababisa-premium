                        ...
                        <form action="{{ route('admin-transaksi-servis.store') }}" method="post">
                            ...
                            <div class="px-5 py-4 border-t border-slate-200">
                                <div class="flex flex-wrap justify-between space-x-2">
                                    ...
                                    <div>
                                        <a href="{{ route('admin-servis-bisa-diambil.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                            Batal
                                        </a>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="flex space-x-1">
                                    ...
                                    <div
                                        ...
                                        @mouseleave="open = false"
                                    >
                                        <a href="https://wa.me/{{ $nomorwa }}/?text=*Notifikasi%20|%20{{ $toko->nama_toko }}*%20Barang%20Servis%20*{{ $transaction->nama_barang }}*%20dengan%20No.%20Servis%20*{{ $transaction->nomor_servis }}*%20kondisinya%20*{{ $transaction->kondisi_servis }}*%20pada%20tanggal%20{{ \Carbon\Carbon::parse($transaction->tgl_selesai)->translatedFormat('d F Y') }}%20dan%20*{{ $transaction->status_servis }}*%20dengan%20biaya%20Rp.%20{{ number_format($transaction->biaya) }}.%20Terima%20Kasih."  hidetargetblank>
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <canvas id="sig-canvas-{{ $transaction->id }}" class="sig-canvas border rounded w-full h-48 bg-gray-100"></canvas>
                                                <input type="hidden" id="polaInput-{{ $transaction->id }}" wire:model.defer="pola" class="polaInput">
                                                <small class="text-gray-400">Gambar pola (opsional)</small>
                                            </div>

                                            <button type="button" onclick="resetCanvas({{ $transaction->id }})"
                                        ...
                                        <div class="mt-6 flex justify-end space-x-2">
                                            <button onclick="saveCanvasAjax({{ $transaction->id }})"
