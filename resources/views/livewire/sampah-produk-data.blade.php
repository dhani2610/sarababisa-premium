...
@endsection
                ...
                <ul class="flex flex-wrap -m-1">
                    ...
                    <li class="m-1">
                        <a href="{{ route('keranjang-produk') }}">
                            <button class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm bg-indigo-500 text-white duration-150 ease-in-out">Produk</button>
                        </a>
                    </li>
                    <li class="m-1">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                <div x-data="{ modalOpen: false }">
                    <button class="btn bg-rose-500 hover:bg-rose-600 text-white" @click.prevent="modalOpen = true">
                        ...
                        <span class="hidden xs:block ml-2">Bersihkan sampah produk</span>
                    </button>
                            ...
                            <div class="p-5 flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex flex-wrap justify-end space-x-2">
                                        ...
                                        <form action="{{ route('bersihkan-keranjang-produk') }}" method="post">
                                            @method('post')
                                            @csrf
        ...
        <div class="bg-white shadow-lg rounded-sm border border-slate-200 mt-5 mb-8">
            <div class="sm:flex sm:justify-between sm:items-center px-5 py-4">
                <h2 class="font-semibold text-slate-800">Semua Data Produk <span class="text-slate-400 font-medium">{{ $items_count }}</span></h2>
            </div>

            <div class="p-5 overflow-x-auto">
                <table id="trashProductTable" class="table-auto w-full">
                    <thead class="text-xs font-semibold uppercase text-slate-500 bg-slate-50 border-t border-b border-slate-200">
                        <tr>
                            ...
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap text-left">Kategori</th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap text-left">Stok</th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap text-left">Harga Modal</th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap text-left">Harga Jual</th>
    ...
    $(document).ready(function () {
        $('#trashProductTable').DataTable({
            ...
            language: {
                ...
                emptyTable: "Tidak ada data sampah produk"
            }
        });
    });
</script>
