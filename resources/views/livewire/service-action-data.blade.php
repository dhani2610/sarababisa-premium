<div>
            ...
            <div x-data="{ modalOpen: false }">
                ...
                >
                    <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                        ...
                        <!-- Modal content -->
                        <form action="{{ route('tindakan-servis.store') }}" method="post">
                            @csrf
                            <div class="px-5 py-4">
                                <div class="space-y-3">
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input id="modal_sparepart" name="modal_sparepart" class="form-input w-full pl-10 px-2 py-1 input-currency" type="text" required/>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input id="harga_toko" name="harga_toko" class="form-input w-full pl-10 px-2 py-1 input-currency" type="text" required/>
                                            <div class="absolute inset-0 right-auto flex items-center pointer-events-none">
                                                <span class="text-sm text-slate-400 font-medium px-3">Rp.</span>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium mb-1" for="harga_pelanggan">Harga Pelanggan
                                             <span class="text-rose-500">*</span></label>
                                        <div class="relative">
                                            <input id="harga_pelanggan" name="harga_pelanggan" class="form-input w-full pl-10 px-2 py-1 input-currency" type="text" required/>
                                            <div class="absolute inset-0 right-auto flex items-center pointer-events-none">
                                                <span class="text-sm text-slate-400 font-medium px-3">Rp.</span>
                                            </div>
                                        </div>
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            <!-- Start Export Excel -->
            <a href="{{ route('tindakan-servis-export') }}" class="hidden lg:block">
                ...
                <button class="btn bg-white border-emerald-200 hover:border-emerald-300 text-emerald-700" @click.prevent="modalOpen = true" aria-controls="tambah-modal">
                    ...
                    >
                        <div class="bg-white rounded shadow-lg overflow-auto max-w-xl w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                ...
                                <div class="px-5 py-4">
                                    <div class="flex flex-wrap justify-end space-x-2">
                                        <a href="{{ asset('storage/assets/format_tindakan.xlsx') }}" class="btn-sm bg-orange-500 hover:bg-orange-600 text-white">
                                            <span class="mr-1">
                ...
                for (let i = 0; i < totalChunks; i++) {
                    ...
                    try {
                        const response = await $.ajax({
                            url: "{{ route('tindakan.servis.import-chunk') }}",
                            method: "POST",
                            data: {
                                _token: "{{ csrf_token() }}",
                                rows: chunk
