    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="bg-white shadow-lg rounded-sm border border-slate-200 mt-5 mb-8">
          ...
          <form class="flex flex-row gap-2 items-end w-full p-4">
                ...
                <div class="shrink-0">
                    <button type="button" id="btn-filter" class="btn bg-indigo-500 hover:bg-indigo-600 text-white py-2 px-4 whitespace-nowrap">
                        <span class="hidden sm:inline">Terapkan</span> <span class="sm:hidden">Go</span>
                        <svg class="w-4 h-4 sm:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                    </button>
                </div>
               ...
               <table id="karyawan-table" class="table-auto w-full">
                <thead class="text-xs font-semibold uppercase text-slate-500 bg-slate-50 border-t border-b border-slate-200">
                    <tr>
                        ...
                        <th class="px-2 py-3">Periode</th> <th class="px-2 py-3">Nama</th>
                        <th class="px-2 py-3">Jabatan</th>
                        <th class="px-2 py-3">Bonus</th> <th class="px-2 py-3">Gaji Pokok</th>
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <h3 class="text-base font-semibold leading-6 text-gray-900 mb-4" id="printModalTitle">Cetak Slip Gaji</h3>
                    ...
                    <form id="printForm" action="" method="get" target="_blank">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="modal_periode" type="month" name="periode" class="form-input w-full bg-gray-100 text-slate-500 cursor-not-allowed" readonly required>
                        ...
                        <div class="mt-5 sm:flex sm:flex-row-reverse gap-2">
                            ...
                            <button type="button" onclick="sendWAFromModal()" class="btn-sm bg-emerald-500 hover:bg-emerald-600 text-white w-full sm:w-auto flex justify-center gap-1">
                                Kirim WA
                            </button>
    ...
    <script>
        ...
        var table = $('#karyawan-table').DataTable({
            ...
            columns: [
                ...
                { data: 'periode', name: 'periode_label' }, // Kolom baru
                { data: 'name', name: 'name' },
                { data: 'jabatan', name: 'jabatan' },
                { data: 'bonus', name: 'bonus' }, // Kolom baru
                { data: 'gaji', name: 'gaji' },
